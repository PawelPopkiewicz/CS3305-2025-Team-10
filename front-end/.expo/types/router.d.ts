...
declare module 'expo-router' {
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      href: Router.RelativePathString | Router.ExternalPathString | `/_sitemap${`?${string}` | `#${string}` | ''}` | `${'/(tabs)'}${`?${string}` | `#${string}` | ''}` | `/${`?${string}` | `#${string}` | ''}` | `${'/(tabs)'}/map${`?${string}` | `#${string}` | ''}` | `/map${`?${string}` | `#${string}` | ''}` | `/config/Colors${`?${string}` | `#${string}` | ''}` | `/math/caclulateDirection${`?${string}` | `#${string}` | ''}` | `/redux/busSlice${`?${string}` | `#${string}` | ''}` | `/redux/favSlice${`?${string}` | `#${string}` | ''}` | `/redux/stopSlice${`?${string}` | `#${string}` | ''}` | `/redux/store${`?${string}` | `#${string}` | ''}` | `/screens/search${`?${string}` | `#${string}` | ''}` | {
      ...
      hrefOutputParams: { pathname: Router.RelativePathString, params?: Router.UnknownOutputParams } | {
        ...
        pathname: `/redux/stopSlice`;
        params?: Router.UnknownOutputParams;
      } | { pathname: `/redux/store`; params?: Router.UnknownOutputParams; } | {
        pathname: `/screens/search`;
        params?: Router.UnknownOutputParams;
      } | { pathname: `/screens/arrivals/[stopId]`, params: Router.UnknownOutputParams & { stopId: string; } } | {
        pathname: `/screens/trip/[busId]`,
        params: Router.UnknownOutputParams & { busId: string; }
      };
    }
  }
}
